...
export const COSTA_ALMERIA_AREAS_2: AreaDetail[] = [
    {
        ...
        headline: 'Fastigheter i Almerimar | Marina och golf',
        metaDescription: 'Köp bostad i Almerimar med svensk rådgivning. Stor marina, golf och långa stränder.',
    ...
    },
    {
        ...
        headline: 'Fastigheter i Cuevas del Almanzora | Grottor och golf',
        metaDescription: 'Köp bostad i Cuevas del Almanzora med svensk rådgivning. Grottbostäder och Desert Springs golf.',
    ...
    },
    {
        ...
        headline: 'Fastigheter i Palomares | Prisvärt vid kusten',
        metaDescription: 'Köp bostad i Palomares med svensk rådgivning. Lugn kustby och låga priser.',
    ...
    },
    {
        ...
        headline: 'Fastigheter i Pulpí | Kristallgrotta och inland',
        metaDescription: 'Köp bostad i Pulpí med svensk rådgivning. Geod, byliv och nära kusten.',
    ...
    },
    {
        ...
        headline: 'Fastigheter i San Juan de los Terreros | Barnvänlig kust',
        metaDescription: 'Köp bostad i San Juan de los Terreros med svensk rådgivning. Långgrunda stränder och nyproduktion.',
