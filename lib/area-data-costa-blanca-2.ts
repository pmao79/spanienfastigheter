...
export const COSTA_BLANCA_AREAS_2: AreaDetail[] = [
    {
        ...
        headline: 'Fastigheter i Santa Pola | Äkta spanskt kustliv',
        metaDescription: 'Köp bostad i Santa Pola med svensk rådgivning. Stränder, saltsjöar och nära Alicante flygplats. Se aktuella objekt.',
    ...
    },
    {
        ...
        headline: 'Fastigheter i El Campello | Familjeliv vid havet',
        metaDescription: 'Köp bostad i El Campello med svensk mäklare. Familjevänligt, strand och TRAM till Alicante. Se aktuella objekt.',
    ...
    },
    {
        ...
        headline: 'Fastigheter i La Nucía | Bergsliv med havsutsikt',
        metaDescription: 'Köp bostad i La Nucía med svensk rådgivning. Villor med utsikt och aktivt expatliv nära Benidorm.',
    ...
    },
    {
        ...
        headline: 'Fastigheter i Alfaz del Pi | Skandinavisk gemenskap',
        metaDescription: 'Köp bostad i Alfaz del Pi med svensk mäklare. Nordisk gemenskap nära Albir och stranden. Se aktuella objekt.',
    ...
    },
    {
        ...
        headline: 'Fastigheter i Finestrat | Panoramautsikt nära Benidorm',
        metaDescription: 'Köp bostad i Finestrat med svensk rådgivning. Moderna villor med havs- och bergsutsikt nära Benidorm.',
    ...
    },
    {
        ...
        headline: 'Fastigheter i Villajoyosa | Färg och spansk charm',
        metaDescription: 'Köp bostad i Villajoyosa med svensk mäklare. Färgglada hus, stränder och genuint stadsliv.',
    ...
    },
    {
        ...
        headline: 'Fastigheter i Rojales | Prisvärt inland nära kusten',
        metaDescription: 'Köp bostad i Rojales med svensk rådgivning. Grotthus, spansk charm och nära stränder.',
    ...
    },
    {
        ...
        headline: 'Fastigheter i Playa San Juan | Alicantes bästa strand',
        metaDescription: 'Köp bostad i Playa San Juan med svensk mäklare. Modern strandnära boende i Alicante. Se aktuella objekt.',
