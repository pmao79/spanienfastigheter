...
export const COSTA_DEL_SOL_AREAS_2: AreaDetail[] = [
    {
        ...
        headline: 'Köp bostad i Manilva – Prisvärt paradis i väst',
        metaDescription: 'Manilva erbjuder prisvärt Costa del Sol-boende med Duquesa marina, stränder och golf. Bästa värdet i regionen. Kontakta oss.',
    ...
    },
    {
        ...
        headline: 'Köp bostad i Nueva Andalucía – Marbellas golfparadis',
        metaDescription: 'Nueva Andalucía är Marbellas Golf Valley med lyxvillor, golfbanor och familjvänligt liv. Premium boende i gröna omgivningar.',
    ...
    },
    {
        ...
        headline: 'Köp bostad i Puerto Banús – Där lyx möter Medelhavet',
        metaDescription: 'Puerto Banús är Costa del Sols glamourösa hjärta med superyachter och designbutiker. Premium fastigheter vid Europas lyxigaste marina.',
    ...
    },
    {
        ...
        headline: 'Köp bostad i San Pedro – Marbellas avslappnade alternativ',
        metaDescription: 'San Pedro Alcántara erbjuder genuint spanskt liv nära Marbella. Strandpromenad, shopping och familjevänligt. Upptäck våra fastigheter.',
    ...
    },
    {
        ...
        headline: 'Köp bostad i Casares – Filosofens vita by',
        metaDescription: 'Casares är en pittoresk vit by med historiskt arv och spektakulär utsikt. Lugnt boende med charm. Kontakta oss för visning.',
    ...
    },
    {
        ...
        headline: 'Köp bostad i Torrox – Officiellt Europas bästa klimat',
        metaDescription: 'Torrox har officiellt Europas bästa klimat! Prisvärt boende på östra Costa del Sol med strand och byliv. Upptäck våra objekt.',
    ...
    },
    {
        ...
        headline: 'Köp bostad i Rincón de la Victoria – Málaga förorten vid havet',
        metaDescription: 'Rincón de la Victoria är Málagas populäraste förort med stränder och stadsnärhet. Perfekt för pendlare och familjer. Kontakta oss.',
    ...
    },
    {
        ...
        headline: 'Köp bostad i Vélez-Málaga – Andalusisk autenticitet',
        metaDescription: 'Vélez-Málaga är Axarquía-regionens huvudstad med rik historia och prisvärt boende. Äkta Andalusien nära kusten. Utforska.',
