...
export const COSTA_BLANCA_AREAS_3: AreaDetail[] = [
    {
        ...
        headline: 'Köp bostad i Campoamor – Där skogen möter havet',
        metaDescription: 'Dehesa de Campoamor erbjuder exklusivt boende med pinjeskogar, stränder och marina. Upptäck lyxvillor och lägenheter i detta premiumområde.',
    ...
    },
    {
        ...
        headline: 'Köp bostad i Playa Flamenca – Puls och strandliv',
        metaDescription: 'Playa Flamenca erbjuder vackra stränder, livlig atmosfär och närhet till shopping. Perfekt för semesterboende och uthyrning. Se våra objekt.',
    ...
    },
    {
        ...
        headline: 'Köp bostad i Villamartín – Golf och gemenskap',
        metaDescription: 'Villamartín är golfarens paradis på Costa Blanca. Levande community kring den berömda Plazan och golfbanan. Hitta din drömbostad här.',
    ...
    },
    {
        ...
        headline: 'Köp bostad i Punta Prima – Modernt vid havet',
        metaDescription: 'Punta Prima erbjuder modernt boende precis vid havet. Känd strandpromenad och hög standard på nyproduktion. Kontakta oss för visning.',
    ...
    },
    {
        ...
        headline: 'Köp bostad i Gran Alacant – Nära allt, med utsikt',
        metaDescription: 'Bara 10 min från flygplatsen ligger Gran Alacant. Kuperat läge med havsutsikt och fantastiska Carabassí-stranden. Perfekt semesterläge.',
    ...
    },
    {
        ...
        headline: 'Köp bostad i Pilar de la Horadada – Genuint och kustnära',
        metaDescription: 'Upptäck Pilar de la Horadada och kustpärlan Torre de la Horadada. Genuin spansk charm, moderna nybyggen och fina stränder. Läs mer här.',
