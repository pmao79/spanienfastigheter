...
export const COSTA_BLANCA_AREAS: AreaDetail[] = [
    {
        ...
        headline: 'Köp bostad i Alicante – Prisvärt paradis på Costa Blanca',
        metaDescription: 'Upptäck Alicante – Costa Blancas hjärta med sol, stränder och spanskt stadsliv. Hitta din drömbostad bland våra fastigheter. Fri rådgivning på svenska.',
        keywords: ['köpa bostad alicante', 'alicante fastigheter', 'costa blanca alicante', 'lägenhet alicante'],
    ...
    },
    {
        ...
        headline: 'Köp bostad i Altea – Costa Blancas kulturella pärla',
        metaDescription: 'Altea – charmigt konstnärsparadis med vitkallade hus, kullersten och havsutsikt. Exklusiva bostäder i autentisk spansk miljö. Kontakta oss idag.',
        keywords: ['köpa bostad altea', 'altea fastigheter', 'villa altea', 'lyxbostad altea'],
    ...
    },
    {
        ...
        headline: 'Köp bostad i Benidorm – Sol, strand och 365 dagars semester',
        metaDescription: 'Benidorm erbjuder prisvärt boende, fantastiska stränder och ständigt solsken. Perfekt för semester och investering. Boka visning idag.',
        keywords: ['köpa lägenhet benidorm', 'benidorm fastigheter', 'investering benidorm', 'havsutsikt benidorm'],
    ...
    },
    {
        ...
        headline: 'Köp bostad i Calpe – Under den ikoniska Ifach-klippan',
        metaDescription: 'Calpe kombinerar dramatisk natur med moderna bekvämligheter. Köp din drömbostad vid Costa Blancas mest ikoniska landmärke. Svensk service.',
        keywords: ['köpa bostad calpe', 'calpe fastigheter', 'villa calpe', 'peñon de ifach'],
    ...
    },
    {
        ...
        headline: 'Köp bostad i Denia – Gastronomisk pärla med Ibiza-charm',
        metaDescription: 'Denia – UNESCO Creative City of Gastronomy med färjor till Ibiza. Autentiskt spanskt liv med internationella influenser. Hitta din bostad idag.',
        keywords: ['köpa bostad denia', 'denia fastigheter', 'villa denia', 'costa blanca nord'],
    ...
    },
    {
        ...
        headline: 'Köp bostad i Jávea – Skandinavernas favoritdestination',
        metaDescription: 'Jávea erbjuder lyxliv och skandinavisk gemenskap vid Costa Blancas finaste vikar. Exklusiva villor och havsnära lägenheter. Svensk rådgivning.',
        keywords: ['köpa villa jávea', 'jávea fastigheter', 'xabia bostad', 'lyx jávea'],
    ...
    },
    {
        ...
        headline: 'Köp bostad i Moraira – Exklusiv fiskebyscharm',
        metaDescription: 'Moraira – liten, exklusiv och charmerande. Lyxvillor vid havet i en av Costa Blancas mest eftertraktade byar. Premium fastigheter med personlig service.',
        keywords: ['köpa villa moraira', 'moraira lyx', 'moraira fastigheter', 'premium costa blanca'],
    ...
    },
    {
        ...
        headline: 'Köp bostad i Torrevieja – Prisvärt paradis för skandinaver',
        metaDescription: 'Torrevieja har Spaniens största skandinaviska gemenskap. Prisvärt boende, vacker kust och allt du behöver. Perfekt för pension och semester.',
        keywords: ['köpa lägenhet torrevieja', 'torrevieja svenskar', 'torrevieja bostad', 'costa blanca syd'],
    ...
    },
    {
        ...
        headline: 'Köp bostad i Orihuela Costa – Golf och strand i perfekt harmoni',
        metaDescription: 'Orihuela Costa med Cabo Roig, La Zenia och Villamartin erbjuder golf, strand och gemenskap. Prisvärt boende nära allt. Upptäck våra objekt.',
        keywords: ['köpa bostad orihuela costa', 'cabo roig', 'la zenia bostad', 'villamartin fastigheter'],
    ...
    },
    {
        ...
        headline: 'Köp bostad i Ciudad Quesada – Lugn och prisvärt nära kusten',
        metaDescription: 'Ciudad Quesada erbjuder prisvärda villor och lugnt inlandsliv nära Costa Blancas stränder. Perfekt för den som söker stillhet och valuta för pengarna.',
    ...
    },
    {
        ...
        headline: 'Köp bostad i Guardamar – Natur och strand i perfekt balans',
        metaDescription: 'Guardamar del Segura erbjuder milsvida tallskogar, sanddyner och vackra stränder. Bostad för den som uppskattar natur och autentiskt spanskt liv.',
        keywords: ['köpa bostad guardamar', 'guardamar del segura', 'naturboende costa blanca', 'strand guardamar'],
