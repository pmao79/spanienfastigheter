...
export const COSTA_DEL_SOL_AREAS: AreaDetail[] = [
    {
        ...
        headline: 'Köp bostad i Marbella – Europas lyxigaste kustdestination',
        metaDescription: 'Marbella erbjuder lyxliv i världsklass med exklusiva villor, golfbanor och strandklubbar. Premium fastigheter för den kräsne. Kontakta oss.',
        keywords: ['köpa villa marbella', 'marbella lyx', 'golden mile', 'marbella fastigheter'],
    ...
    },
    {
        ...
        headline: 'Köp bostad i Málaga – Costa del Sols kulturella hjärta',
        metaDescription: 'Málaga kombinerar kultur, gastronomi och strandliv i Spaniens mest dynamiska stad. Utforska fastigheter i Andalusiens pärlor.',
        keywords: ['köpa bostad malaga', 'malaga centrum', 'malaga fastigheter', 'costa del sol stad'],
    ...
    },
    {
        ...
        headline: 'Köp bostad i Estepona – Trädgårdsstaden vid havet',
        metaDescription: 'Estepona kombinerar charmigt gammalt centrum med moderna lyxprojekt. Prisvärt alternativ till Marbella med all kvalitet. Upptäck våra objekt.',
        keywords: ['köpa bostad estepona', 'estepona fastigheter', 'estepona lyx', 'costa del sol väst'],
    ...
    },
    {
        ...
        headline: 'Köp bostad i Fuengirola – Familjeliv vid 8 km strand',
        metaDescription: 'Fuengirola erbjuder perfekt familjeliv med långa stränder, djurpark och stark svensk gemenskap. Prisvärt och bekvämt. Kontakta oss.',
        keywords: ['köpa bostad fuengirola', 'fuengirola svenskar', 'fuengirola strand', 'familj costa del sol'],
    ...
    },
    {
        ...
        headline: 'Köp bostad i Benalmádena – Tre världar i en stad',
        metaDescription: 'Benalmádena erbjuder strand, vitkalkat bergspu och modern marina. Linbana med panoramautsikt och familjeattraktioner. Upptäck våra fastigheter.',
        keywords: ['köpa bostad benalmadena', 'benalmadena costa', 'puerto marina', 'tivoli world'],
    ...
    },
    {
        ...
        headline: 'Köp bostad i Mijas Pueblo – Vitkalkat paradis',
        metaDescription: 'Mijas Pueblo erbjuder klassisk andalusisk charm med vitkallade hus, åsnor och fantastisk utsikt. Autentiskt liv med modern bekvämlighet.',
        keywords: ['köpa bostad mijas', 'mijas pueblo', 'vitkalkat hus spanien', 'andalusien by'],
    ...
    },
    {
        ...
        headline: 'Köp bostad i Nerja – Europas balkong vid havet',
        metaDescription: 'Nerja erbjuder spektakulära Balcón de Europa, berömda grottor och genuint spanskt liv. Östra Costa del Sols pärla med unika fastigheter.',
        keywords: ['köpa bostad nerja', 'nerja balcon de europa', 'nerja grottor', 'costa del sol öst'],
    ...
    },
    {
        ...
        headline: 'Köp bostad i Torremolinos – Klassiker med modern charm',
        metaDescription: 'Torremolinos erbjuder prisvärt strandboende nära Málagas flygplats. La Carihuela fiskarkvarter och brett utbud. Upptäck våra objekt.',
        keywords: ['köpa bostad torremolinos', 'la carihuela', 'torremolinos strand', 'malaga nära flygplats'],
    ...
    },
    {
        ...
        headline: 'Köp bostad i Benahavís – Lyx, natur och gastronomi',
        metaDescription: 'Benahavís erbjuder lyxvillor i naturskön miljö med prisbelönta restauranger. Del av Golden Triangle med Marbella och Estepona.',
    ...
    },
    {
        ...
        headline: 'Köp bostad i Mijas Costa – Strand och golf för alla',
        metaDescription: 'Mijas Costa erbjuder strandnära boende och golf för familjer. La Cala de Mijas, Calahonda och Riviera del Sol. Utforska våra fastigheter.',
    ...
    },
    {
        ...
        headline: 'Köp bostad i Sotogrande – Ultimat lyx och polo',
        metaDescription: 'Sotogrande är Costa del Sols mest exklusiva destination med polo, golf och diskret lyx. Premium fastigheter för den som kräver det bästa.',
