...
export const COSTA_BLANCA_AREAS_5: AreaDetail[] = [
    {
        ...
        headline: 'Fastigheter i Vega Baja | Inland och byliv',
        metaDescription: 'Köp bostad i Vega Baja inland med svensk rådgivning. Genuina byar och prisvärt boende nära Costa Blanca.',
    ...
    },
    {
        ...
        headline: 'Fastigheter i Mil Palmeras | Strandliv bland palmer',
        metaDescription: 'Köp bostad i Mil Palmeras med svensk mäklare. Populär strand, gröna omgivningar och familjevänligt.',
    ...
    },
    {
        ...
        headline: 'Fastigheter i Torre de la Horadada | Spansk kustcharm',
        metaDescription: 'Köp bostad i Torre de la Horadada med svensk rådgivning. Charmigt torgliv, marina och fina stränder.',
    ...
    },
    {
        ...
        headline: 'Fastigheter i Las Colinas Golf | Exklusiv resort',
        metaDescription: 'Köp bostad på Las Colinas Golf med svensk rådgivning. Premium villor och lägenheter i naturskön resortmiljö.',
    ...
    },
    {
        ...
        headline: 'Fastigheter i Las Ramblas | Golf i grönska',
        metaDescription: 'Köp bostad i Las Ramblas med svensk mäklare. Golfbana i kuperad natur nära kusten.',
    ...
    },
    {
        ...
        headline: 'Fastigheter i Vistabella Golf | Prisvärt och modernt',
        metaDescription: 'Köp bostad i Vistabella Golf med svensk rådgivning. Modern nyproduktion runt golfbana.',
    ...
    },
    {
        ...
        headline: 'Fastigheter i Aguas Nuevas | Torrevieja norr',
        metaDescription: 'Köp bostad i Aguas Nuevas med svensk mäklare. Nära strand, stad och service i Torrevieja.',
    ...
    },
    {
        ...
        headline: 'Fastigheter i La Mata | Strand och naturpark',
        metaDescription: 'Köp bostad i La Mata med svensk rådgivning. Lång sandstrand, naturpark och lugn atmosfär.',
    ...
    },
    {
        ...
        headline: 'Fastigheter i La Veleta | Exklusivt vid havet',
        metaDescription: 'Köp bostad i La Veleta med svensk mäklare. Prestigefyllt villaområde i Torrevieja.',
    ...
    },
    {
        ...
        headline: 'Fastigheter i Los Altos | Nära Punta Prima',
        metaDescription: 'Köp bostad i Los Altos med svensk rådgivning. Etablerat område nära service och strand.',
    ...
    },
    {
        ...
        headline: 'Fastigheter i Los Balcones | Utsikt över saltsjön',
        metaDescription: 'Köp bostad i Los Balcones med svensk mäklare. Stora tomter, lugn miljö och utsikt över saltsjön.',
