...
async function main() {
    ...
    // We will hardcode the replacement for the entire file content or specific blocks to ensure quality.
    // Given the file size, replacing the ARRAY content is safer.
...
export const COSTA_CALIDA_AREAS_2: AreaDetail[] = [
    ...
    },
    {
        ...
        districts: [
            { name: 'Strandnära', character: 'Äldre lägenheter, bästa läget', pricePerM2: 2600, suitableFor: ['Semesterfirare'], pros: ['Utsikt', 'Nära bad'], cons: ['Äldre standard'] },
            { name: 'Villaområden', character: 'Nyproduktion och villor', pricePerM2: 2900, suitableFor: ['Året-runt', 'Lyxsökare'], pros: ['Hög standard', 'Privat pool'], cons: ['Längre från havet'] }
        ],
        whySwedes: [
    ...
    },
    {
        ...
        districts: [
            ...
            { name: 'Zona Norte', character: 'Nytt, modernt, barnvänligt', pricePerM2: 1800, suitableFor: ['Familjer'], pros: ['Bra skolor', 'Rymligt'], cons: ['Längre till centrum'] }
        ],
        whySwedes: [
    ...
    },
    {
        ...
        districts: [
            { name: 'Ribera - Stranden', character: 'Turistigt, äldre bebyggelse', pricePerM2: 2200, suitableFor: ['Semester'], pros: ['Läget'], cons: ['Parkering'] },
            { name: 'San Javier - Stad', character: 'Vardagsliv, service', pricePerM2: 1300, suitableFor: ['Året-runt'], pros: ['Billigare', 'Service'], cons: ['Ej havsnära'] }
        ],
        whySwedes: [
    ...
    },
    {
        ...
        districts: [
            { name: 'Lo Pagán', character: 'Turistpuls, strandnära', pricePerM2: 2100, suitableFor: ['Semester'], pros: ['Nära havet'], cons: ['Sommarträngsel'] },
            { name: 'San Pedro Stad', character: 'Vardag, service, lugnare', pricePerM2: 1500, suitableFor: ['Året-runt'], pros: ['Service', 'Öppet'], cons: ['Bit till stranden'] }
        ],
        whySwedes: [
    ...
    },
    {
        ...
        districts: [
            { name: 'Santa Rosalia', character: 'Exklusivt, lagun, nytt', pricePerM2: 3000, suitableFor: ['Investerare', 'Lyxsökare'], pros: [' unikt', 'Modernt'], cons: ['Dyrare'] },
            { name: 'Mar Menor Golf', character: 'Etablerat, nära stad', pricePerM2: 1800, suitableFor: ['Golfare'], pros: ['Välskött', 'Nära service'], cons: ['Äldre hus'] },
            { name: 'La Torre', character: 'Prisvärt, lugnt', pricePerM2: 1200, suitableFor: ['Semester', 'Budget'], pros: ['Billigt'], cons: ['Lite ödsligt ibland'] }
        ],
        whySwedes: [
...
`;
    ...
    fs.writeFile(targetPath, fullContent, 'utf-8');
    console.log('Successfully updated all Costa Cálida areas to Swedish Gold Standard.');
}
